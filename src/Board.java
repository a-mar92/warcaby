    ...
    public void pionekRuch(int player) {
        if (player == 2 ) {
            ...
            if (board[moveDown.getWierszDownKomputer()][moveDown.getKolumnaDownKomputer()].equals("W")){
                ...
                board[moveDown.getWierszDownKomputer()][moveDown.getKolumnaDownKomputer()] = "B";

                pionkiW--;
            } else if (moveDown.getKolumnaDownKomputer() >=7) {
                moveDown.setKolumnaDownKomputer(5);
                if (board[moveDown.getWierszDownKomputer()][moveDown.getKolumnaDownKomputer()].equals("W")){
                    System.out.println("Zbiłeś pionka przeciwnika");
                    board[moveUp.getWierszKomputer()][moveUp.getKolumnaKomp()] = "-";
                    board[moveDown.getWierszDownKomputer()][moveDown.getKolumnaDownKomputer()] = "B";
            ...
            }else if ((board[moveDown.getWierszDownKomputer()][moveDown.getKolumnaDownKomputer()]).equals("B")){
                moveUp.executionMoveComputer();
                if (board[moveDown.getWierszDownKomputer()][moveDown.getKolumnaDownKomputer()].equals("W")){
                    System.out.println("Zbiłeś pionka przeciwnika");
                    board[moveUp.getWierszKomputer()][moveUp.getKolumnaKomp()] = "-";
